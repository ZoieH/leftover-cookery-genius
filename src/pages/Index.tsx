    ...
    <>
      ...
      <Layout>
        <div className="container py-12">
          {/* Hero Section with Better H1 */}
          <div className="max-w-2xl mx-auto text-center mb-10">
            <h1 className="text-4xl font-bold mb-4 bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">
              AI Recipe Generator for Leftover Ingredients
            </h1>
            <h2 className="text-xl font-semibold mb-4 text-muted-foreground">
              Turn Your Leftovers into Delicious Meals
            </h2>
            <p className="text-muted-foreground mb-6 text-lg">
              Snap a picture of your leftover ingredients and our AI will suggest delicious recipes you can make. 
              Reduce food waste and discover new ways to cook with what you have.
            </p>
          </div>
